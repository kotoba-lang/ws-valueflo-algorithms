...
GLEIF LEI publishes daily deltas; this job runs 3x/week (Mon/Wed/Fri) to follow
new legal-entity registrations into a valueflow recipe shape.
"""
import json
import os
import subprocess
...
def refuse(why):
    print("REFUSED — no GLEIF valueflow analysis was measured this run.")
    print(why)
    print()
